...
cpdef object read_date(bytes binary_data, object array_function, object buffer, long pgoid):
    """Unpack date value."""

    return DEFAULT_DATE + timedelta(days=unpack("!i", binary_data)[0])


cpdef bytes write_date(object dtype_value, object array_function, object buffer, long pgoid):
    """Pack date value."""
...
cpdef object read_timestamp(bytes binary_data, object array_function, object buffer, long pgoid):
    """Unpack timestamp value."""

    return DEFAULT_DATETIME + timedelta(microseconds=unpack("!q", binary_data)[0])
...
cpdef object read_timestamptz(bytes binary_data, object array_function, object buffer, long pgoid):
    """Unpack timestamptz value."""

    return read_timestamp(binary_data, array_function, buffer, pgoid).replace(tzinfo=timezone.utc)


cpdef bytes write_timestamptz(object dtype_value, object array_function, object buffer, long pgoid):
    """Unpack timestamptz value."""

    return read_timestamp(dtype_value.astimezone(timezone.utc), array_function, buffer, pgoid)


cpdef object read_time(bytes binary_data, object array_function, object buffer, long pgoid):
    """Unpack time value."""

    cdef long long microseconds, total_seconds, total_minutes, hours, minutes, seconds, microsecond
...
cpdef bytes write_time(object dtype_value, object array_function, object buffer, long pgoid):
    """Pack time value to pgcopy binary format."""

    cdef long long hour_per_microsecond = dtype_value.hour * SECONDS_PER_HOUR * MICROSECONDS_PER_SECOND
    cdef long long minute_per_microsecond = dtype_value.minute * SECONDS_PER_MINUTE * MICROSECONDS_PER_SECOND
    cdef long long second_per_microsecond = dtype_value.second * MICROSECONDS_PER_SECOND
...
cpdef object read_timetz(bytes binary_data, object array_function, object buffer, long pgoid):
    """Unpack timetz value."""

    cdef object time_notz = read_time(binary_data, array_function, buffer, pgoid)
...
cpdef bytes write_timetz(object dtype_value, object array_function, object buffer, long pgoid):
    """Pack timetz value."""
...
cpdef object read_interval(bytes binary_data, object array_function, object buffer, long pgoid):
...
cpdef bytes write_interval(object dtype_value, object array_function, object buffer, long pgoid):
    """Pack interval value."""
    ...
    cdef long long hour_per_microsecond = hours * SECONDS_PER_HOUR * MICROSECONDS_PER_SECOND
    cdef long long minute_per_microsecond = minutes * SECONDS_PER_MINUTE * MICROSECONDS_PER_SECOND
    cdef long long second_per_microsecond = seconds * MICROSECONDS_PER_SECOND
    cdef long long total_microseconds = (
        hour_per_microsecond +
        minute_per_microsecond +
        second_per_microsecond +
